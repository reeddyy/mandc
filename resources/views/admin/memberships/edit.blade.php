    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.memberships.update", [$membership->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_status') ? 'is-invalid' : '' }}" type="text" name="member_status" id="member_status" value="{{ old('member_status', $membership->member_status) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_reference') ? 'is-invalid' : '' }}" type="text" name="member_reference" id="member_reference" value="{{ old('member_reference', $membership->member_reference) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_class') ? 'is-invalid' : '' }}" type="text" name="member_class" id="member_class" value="{{ old('member_class', $membership->member_class) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_name') ? 'is-invalid' : '' }}" type="text" name="member_name" id="member_name" value="{{ old('member_name', $membership->member_name) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('member_email') ? 'is-invalid' : '' }}" type="email" name="member_email" id="member_email" value="{{ old('member_email', $membership->member_email) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('date_awarded') ? 'is-invalid' : '' }}" type="text" name="date_awarded" id="date_awarded" value="{{ old('date_awarded', $membership->date_awarded) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('membership_validity') ? 'is-invalid' : '' }}" type="text" name="membership_validity" id="membership_validity" value="{{ old('membership_validity', $membership->membership_validity) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('awarding_body') ? 'is-invalid' : '' }}" type="text" name="awarding_body" id="awarding_body" value="{{ old('awarding_body', $membership->awarding_body) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('training_credits') ? 'is-invalid' : '' }}" type="text" name="training_credits" id="training_credits" value="{{ old('training_credits', $membership->training_credits) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('support_funds') ? 'is-invalid' : '' }}" type="text" name="support_funds" id="support_funds" value="{{ old('support_funds', $membership->support_funds) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('digital_member_card') ? 'is-invalid' : '' }}" type="text" name="digital_member_card" id="digital_member_card" value="{{ old('digital_member_card', $membership->digital_member_card) }}">
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('note') ? 'is-invalid' : '' }}" name="note" id="note">{{ old('note', $membership->note) }}</textarea>
                @if($errors->has('note'))
                    <div class="invalid-feedback">
                        {{ $errors->first('note') }}
                    </div>
