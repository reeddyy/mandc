...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.ada.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.adas.store") }}" enctype="multipart/form-data">
            @csrf
            <div class="form-group">
                <label for="member_reference">{{ trans('cruds.ada.fields.member_reference') }}</label>
                <input class="form-control {{ $errors->has('member_reference') ? 'is-invalid' : '' }}" type="text" name="member_reference" id="member_reference" value="{{ old('member_reference', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('award_validity') ? 'is-invalid' : '' }}" type="text" name="award_validity" id="award_validity" value="{{ old('award_validity') }}">
            ...
            <div class="form-group">
                <label for="award_reference">{{ trans('cruds.ada.fields.award_reference') }}</label>
                <input class="form-control {{ $errors->has('award_reference') ? 'is-invalid' : '' }}" type="text" name="award_reference" id="award_reference" value="{{ old('award_reference', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('award_status') ? 'is-invalid' : '' }}" type="text" name="award_status" id="award_status" value="{{ old('award_status', '') }}">
