    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.certificates.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credential_reference') ? 'is-invalid' : '' }}" type="text" name="credential_reference" id="credential_reference" value="{{ old('credential_reference', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recipient_name') ? 'is-invalid' : '' }}" type="text" name="recipient_name" id="recipient_name" value="{{ old('recipient_name', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('credential_title') ? 'is-invalid' : '' }}" type="text" name="credential_title" id="credential_title" value="{{ old('credential_title', '') }}">
